...
export default function LandingPage() {
  return (
    <div className="h-screen w-full flex flex-col md:flex-row overflow-hidden font-sans">
      ...
      <Link 
        href="/tools"
        className="group relative flex-1 bg-yellow-400 flex flex-col items-center justify-center p-8 transition-all duration-500 hover:flex-[1.2] border-b-8 md:border-b-0 md:border-r-8 border-black z-10 hover:z-20 shadow-[0_0_50px_rgba(0,0,0,0.2)]"
      >
      ...
      <Link 
        href="/games"
        className="group relative flex-1 bg-blue-500 flex flex-col items-center justify-center p-8 transition-all duration-500 hover:flex-[1.2] z-10 hover:z-20 shadow-[0_0_50px_rgba(0,0,0,0.2)]"
      >
      ...
      {/* Center Logo Overlay */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-30 flex flex-col items-center gap-8 pointer-events-none">
        <div 
          className="bg-black text-white px-8 py-4 rounded-full border-4 border-white shadow-[0_0_30px_rgba(0,0,0,0.5)] transform -rotate-2 cursor-pointer pointer-events-auto hover:scale-105 transition-transform"
          onClick={() => {
        ...
        >
          <h1 className="text-4xl md:text-5xl font-black italic tracking-tighter uppercase text-center select-none">
            CRAZYVERSE
          </h1>
        </div>
        
        <div className="pointer-events-auto transform rotate-2 flex flex-col gap-4 w-full px-4">
          <RandomBoredomButton />
          
          <Link 
            href="/doom-scroll"
            className="group relative bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-400 hover:to-purple-500 text-white font-black uppercase tracking-widest text-lg py-4 px-8 rounded-full border-4 border-black shadow-[8px_8px_0_rgba(0,0,0,1)] hover:-translate-y-1 hover:shadow-[12px_12px_0_rgba(0,0,0,1)] transition-all duration-300 flex items-center justify-center gap-2 overflow-hidden text-center"
          >
            ...
            <span className="relative z-10">TikTok Mode (Doom Scroll)</span>
          </Link>
        </div>
      </div>
    </div>
